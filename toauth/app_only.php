...
define('CONSUMER_KEY', 'FdQyesvUak0Kmk24twJGrBllD');
define('CONSUMER_SECRET', 'xgOzBQaHTv10HcqLXsPwTztYS0MAj3hz7CIMgOayraUnHSY3sq');
/**
...
function get_followers_count($bearer_token){
    $url = "https://api.twitter.com/1.1/users/show.json?screen_name=nkoreaoffline"; // base url
    $headers = array(
        "GET /1.1/users/show.json?screen_name=nkoreaoffline HTTP/1.1",
        "Host: api.twitter.com",
        "User-Agent: jonhurlock Twitter Application-only OAuth App v.1",
        "Authorization: Bearer ".$bearer_token
    );
